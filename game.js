...
function findSquare(object) {
    for (let index = 0; index < 3; index++) {
        for (let index1= 0; index1 < 3; index1++) {
               if (board.board[index][index1].getAttribute("id")==object.getAttribute("id")) {
...
for (let index = 0; index < winStates.length; index++) {
    ...
    if (board.board[pos1[0]][pos1[1]].innerHTML==board.board[pos2[0]][pos2[1]].innerHTML&&board.board[pos1[0]][pos1[1]].innerHTML==board.board[pos3[0]][pos3[1]].innerHTML && board.board[pos1[0]][pos1[1]].innerHTML!="") {
